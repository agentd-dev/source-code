...
//! A compact, dependency-free SHA-256 (FIPS 180-4) — the workflow-identity hash
//! (RFC 0021 §8.2). A checkpoint envelope binds the graph it was taken from by
...
//! verified against the FIPS/NIST test vectors below. NOT used for secrets or
//! signatures — identity binding only.
