...
function parseArgs(argv: string[]): Args {
  const out: Args = { debug: false, help: false };
...
if (args.help) {
  process.stdout.write(
    [
      ...
      '',
      '  agentd-tui --endpoint http://127.0.0.1:8420 [--bearer TOKEN] [--code 123456] [--debug] [--insecure]',
      '',
      '  --code   pair with the rotating code the operator shows (/pair) instead of a bearer',
      '  env: AGENTD_ENDPOINT, AGENTD_BEARER, AGENTD_INSECURE=1',
...
render(<App endpoint={endpoint} bearer={bearer} debug={args.debug} />);
