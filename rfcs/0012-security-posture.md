...
pub struct HttpPolicy {
    pub require_https: bool,        // default true; AGENTD_HTTP_ALLOW_PLAINTEXT=1 to relax
...
- **Use sites:** the intelligence credential (`AGENTD_INTELLIGENCE_TOKEN` + provider-specific,
